...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("OpenAPI Petstore")
                .description(
    ...
    class BasePathAwareRelativePathProvider extends RelativePathProvider {
        ...
        protected String applicationPath() {
            return Paths.removeAdjacentForwardSlashes(UriComponentsBuilder
                    .fromPath(super.applicationPath()).path(basePath).build().toString());
        }
        ...
        public String getOperationPath(String operationPath) {
            ...
            return Paths.removeAdjacentForwardSlashes(uriComponentsBuilder
                    .path(operationPath.replaceFirst("^" + basePath, "")).build().toString());
        }
    }
