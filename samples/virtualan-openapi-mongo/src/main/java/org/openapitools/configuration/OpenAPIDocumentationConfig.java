...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            ...
            .termsOfServiceUrl("http://virtualan.io")
            .version("0.0.2")
            .contact(new Contact("","", "elan.thangamani@virtualan.io"))
            .build();
    }

    @Bean
    public Docket customImplementation(ServletContext servletContext, @Value("${openapi.employeeSampleSpecification.base-path:/api}") String basePath) {
