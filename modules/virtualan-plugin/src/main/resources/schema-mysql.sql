...
CREATE TABLE  virtual_service (id INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,  operationid varchar(250), priority int,
                input MEDIUMTEXT  , output MEDIUMTEXT  , resources varchar(50),url varchar(250),  type varchar(50),
                method varchar(50), httpStatusCode varchar(50),excludeList varchar(250),rule varchar(2500),
